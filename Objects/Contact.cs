...
namespace IIS.223vvyy
{
    ...
    public class Contact : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.223vvyy.ContactType fContactType;
        
        private IIS.223vvyy.DetailArrayOfPhone fPhone;
        ...
        [NotNull()]
        public virtual IIS.223vvyy.ContactType ContactType
        {
            get
            {
                ...
                IIS.223vvyy.ContactType result = this.fContactType;
        ...
        public virtual IIS.223vvyy.DetailArrayOfPhone Phone
        {
            get
            {
                ...
                if ((this.fPhone == null))
                {
                    this.fPhone = new IIS.223vvyy.DetailArrayOfPhone(this);
                }
                IIS.223vvyy.DetailArrayOfPhone result = this.fPhone;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ContactE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ContactE", typeof(IIS.223vvyy.Contact));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ContactL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ContactL", typeof(IIS.223vvyy.Contact));
                }
            }
        }
    }
